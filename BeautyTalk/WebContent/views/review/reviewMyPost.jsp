...
<body>
	...
	<form id="form_review1">
		<table id="table_my_review1" align="left">
			<br>
			<tr>
				<th id="review_img1" style="width: 300px;"><img
					src="resources/images/3" alt=""> <span> 마이페이지 </span></th>
			</tr>
			<tr>
			...
			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"><pre>  회원정보수정</pre>
				</td>
			</tr>

			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"><pre>  회원탈퇴</pre>
				</td>
			</tr>

			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"><pre>  왓츠 인 마이 백</pre>
				</td>
			</tr>

			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"><pre>  뷰티 캘린더</pre>
				</td>
			</tr>

			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"><pre>  알림내역</pre>
				</td>
			</tr>
			...
			<tr>
				<td class="td_review1"
					...
					style="border-bottom: 1px solid gray;"><pre>  팔로워</pre></td>
			</tr>
			<tr>
				<td style="height: 10px;"></td>
			</tr>
			...
			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"><pre>  문의 내역</pre>
				</td>
			</tr>

			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"><pre>  1:1 문의하기</pre>
				</td>
			</tr>
			...
			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"
					style="border-bottom: 1px solid gray;"><pre>  공지사항</pre></td>
			</tr>
			<tr>
				<td style="height: 10px;"></td>
			</tr>
			...
			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"
					style="border-bottom: 1px solid gray;"><pre>  댓글내역</pre></td>
			</tr>
			<tr>
				<td style="height: 10px;"></td>
			</tr>
			...
			<tr>
				<td class="td_review1"
					onclick="location.href='https://www.daum.net/'"><pre>  신고 내역</pre>
				</td>
			</tr>
		...
		<table id="table_my_review2" align="left">
				...
				<td align="right" style="width: 100px;">
					<button type="button" style="width: 100px;">
						<a href="<%= contextPath %>/review.wr"
							style="text-decoration-line: none;"> <b>+ 리뷰 작성</b>
						</a>
					</button>
				</td>
				<td></td>
			...
			<tr>
				...
				<td colspan="4" class="review_title1"
					onclick="location.href='https://www.daum.net/'"><b>리뷰 제목1</b></td>
