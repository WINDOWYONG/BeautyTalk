...
>>>>>>> reviewPost
			...
			<form action="<%= contextPath %>/insert.me" id="insert-form"
				method="post">
				<input type="hidden" name="Token" value="<%= Token %>"> <input
					type="text" name="userId" id="userId" minlength="6" maxlength="15"
					placeholder="아이디를 입력하세요. (6자 이상 15자 이내)" required> <input
					type="password" name="userPwd" id="userPwd" minlength="8"
				...
				<input type="text" name="userName" id="userName" maxlength="16"
					...
					name="email" id="email" minlength="8" maxlength="20"
					placeholder="이메일을 입력하세요." required> <input type="text"
					name="nickName" id="nickName" minlength="2" maxlength="10"
					placeholder="닉네임을 입력하세요" required> <input type="text"
					name="birthDate" id="birthDate" minlength="8" maxlength="8"
					placeholder="생년월일 ex) 19990812" required> <input
					type="text" name="phone" id="phone" minlength="8" maxlength="11"
				...
				<input type="text" name="userName" id="userName" maxlength="16"
					placeholder="이름을 입력하세요." required value="<%= userName %>">


				<input type="text" name="email" id="email" minlength="8"
					maxlength="20" placeholder="이메일을 입력하세요." required
					value="<%= email %>"> <input type="text" name="nickName"
					id="nickName" minlength="2" maxlength="10" placeholder="닉네임을 입력하세요"
					required> <input type="text" name="birthDate"
					id="birthDate" minlength="8" maxlength="8"
					placeholder="생년월일 ex) 19990812" required
					value="<%= birthyear + birthday %>"> <input type="text"
					name="phone" id="phone" minlength="8" maxlength="11"
					placeholder="휴대전화번호 ex) 01011112222" required value="<%= phone %>">
				<% } %>
				<div id="gender">

					<input type="checkbox" name="gender" value="M"> 남자 <input
						type="checkbox" name="gender" value="F"> 여자
				...
				<div id="agree1">
					<div id="agree2">
						<div id="agree3">
							<div>
								<!-- 전체 동의 체크박스 -->
								<input type="checkbox" id="agreeAll" name="agree"
									style="vertical-align: bottom" value="Y" required> <label
									for="agreeAll"> <b
									style="color: #e8618c; vertical-align: 4px">[필수]</b> <span
									style="font-weight: 800; vertical-align: 3px">이용 약관 전체동의</span>
								</label>
								...
								<div id="termsContainer" class="hidden">
									<label><input type="checkbox"
										class="term-checkbox required"> [필수] 서비스 이용약관 동의</label><br>
									<label><input type="checkbox"
										class="term-checkbox required"> [필수] 개인정보 처리방침 동의</label><br>
									<label><input type="checkbox" class="term-checkbox">
										[선택] 마케팅 정보 수신 동의</label><br>
								</div>
							</div>
						</div>
					</div>
				...
				<button type="submit" class="btn-insta-insert"
					style="font-size: large; font-weight: 600;">회원가입</button>
