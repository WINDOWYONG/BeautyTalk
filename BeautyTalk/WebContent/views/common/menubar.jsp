    ...
    <body>
        <div class="wrap">
            ...
            <div id="header">
                ...
                <div id="header1">
                    <img src="../../../../images/메인로고 짧게자른거.jpg" alt="로고">
                </div>
                ...
                <div id="header3">
                    <div id="header3_top">
                        <a href=""><img src="../../../../images/댓글아이콘.png" alt="메시지"></a>
                        <a href=""><img src="../../../../images/알림아이콘.png" alt="알림"></a>
                        <a href="">로그아웃</a>
                        <span>|</span>
                        <a href="">마이페이지</a>
                    </div>
            ...
            <div class="content">
                <div class="main_banner">
                    <a href="" class="banner_link">
                        <img class="img_content" src="../../../../images/메인배너.png" alt=""></div>
                    </a>
                </div>
        <script>
